...
REM Set the path to your conda activation script and activate the environment.
...
REM Run the CLI command. Your path would look something like this on windows "C:\my-video-folder"
